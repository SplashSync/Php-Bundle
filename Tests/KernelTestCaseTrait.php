...
/**
 * @abstract    Splash Symfony Test Suite - Exetension of Symfony Test Case for Splash Test Classes
 *
...
//        fwrite(STDOUT, __METHOD__ . "\n");
    ...
    /**
     * @abstract    Overide Core Data Provider to Boot Kernel Before
     */
    public function ObjectTypesProvider()
    {
        self::setUpBeforeClass();
        return parent::ObjectTypesProvider();
    }  
    ...
    {
        self::setUpBeforeClass();
        return parent::ObjectFieldsProvider();
    }  
